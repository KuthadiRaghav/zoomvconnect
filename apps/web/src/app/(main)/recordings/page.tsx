                        ...
                        {filtered.map((rec) => (
                            ...
                            >
                                ...
                                <div className="aspect-video bg-gray-800 relative overflow-hidden">
                                    <div className="absolute inset-0 bg-gradient-to-br from-gray-800 via-gray-850 to-gray-900 group-hover:scale-105 transition-transform duration-500" />
                                    ...
                                    <div className="flex gap-2">
                                        {rec.status === "READY" && rec.videoUrl && (
                                            <a
                                                href={rec.videoUrl}
                                                download
                                                className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-primary-600/20 hover:bg-primary-600/30 text-primary-400 rounded-lg transition-colors text-xs font-medium"
                                            >
                                                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center justify-center gap-1.5 py-2 px-3 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-lg transition-colors text-xs font-medium"
