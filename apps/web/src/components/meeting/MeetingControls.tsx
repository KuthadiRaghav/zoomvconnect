            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-black/60 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl min-w-max mx-auto">
                ...
                {onToggleCaptions && (
                    <ControlButton
                        ...
                        activeClass="bg-teal-600/80 text-white border border-teal-500/50"
                        inactiveClass="bg-gray-700 text-gray-400 hover:bg-gray-600 hover:text-white"
                        label={captionsEnabled ? "Hide Captions" : "Live Captions"}
                    >
