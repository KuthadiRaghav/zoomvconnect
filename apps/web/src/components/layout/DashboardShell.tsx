...
export default function DashboardShell({
    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white selection:bg-primary-500/30">
            {/* Mobile Header - Fixed at top, outside main to ensure Z-index dominance */}
            <header className="lg:hidden fixed top-0 left-0 right-0 z-[100] flex items-center justify-between p-4 bg-gray-950/80 backdrop-blur-xl border-b border-white/5 h-16">
